function getBookData() {
    return {
        '0': {
            ...
            'films': [
                '«Этот фантастический мир. Выпуск 1» 1979, СССР, реж:',
            ],
        },
        '1': {
            'id': '1666',
            ...
            'quote_4': '– А еще сладких пирожков и сыра, – поспешил добавить Бофур.– Пирог с поросятинкой и салат, – облизнулся Бомбур.',
            ...
            'films': [
                '«Сказочное путешествие мистера ______ ________, _______» 1985, СССР, реж: Владимир Латышев',
                '«______» 1977, США, реж: Жуль Басс, Артур Ранкин мл.',
                '«______: Нежданное путешествие» 2012, США, Новая Зеландия, реж: Питер Джексон',
            ],
        },
        '2': {
            'id': '7182',
        ...
        '3': {
            ...
            'quote_3': 'Носферату не умирает, как пчела, после того как ужалит.',
            'quote_4': '– Я отрублю ей голову, набью рот чесноком и вобью кол в ее тело.',
            'quote_5': 'В Трансильвании живут четыре различные народности: на юге – саксонцы вперемешку с валахами, народом, происходящим от даков; на западе венгры, и секли на востоке и севере.',
            'quote_6': 'Я в полном недоумении, поэтому решился на следующий шаг: я списался с моим старым учителем и добрым другом профессором Ван Хелсингом из Амстердама, который великолепно разбирается в сомнительных случаях, и просил его приехать.',
            ...
            'films': [
                ...
                '«_______ _____ _______» 1992, США, реж: Френсис Форд Коппола',
            ],
        },
        '4': {
            'id': '15230',
        ...
        '5': {
            ...
            'quote_2': 'Потом я поглядел на верхнюю страницу с заглавием – «ЗАВОДНОЙ АПЕЛЬСИН» – и говорю: – Фу, до чего глупое название. Слыханное дело – заводной апельсин?',
            'quote_3': 'спросить насчет давно обещанной и давно заказанной пластинки с записью Девятой (она же Хоральная) симфонии Бетховена (фирма «Мастер-строук», дирижер Л. Мухайвир).',
            'quote_4': 'там все больше шла душеспасительная говорильня, а про войны и всякие там sunnvynn почти ничего не было.',
        ...
        '6': {
            ...
            'quote_1': 'Умереть можно и в компании телевизора. Лишь бы там было, что смотреть сегодня вечером.',
            'quote_2': 'Возможно, самосовершенствование — это ещё не все. Возможно, саморазрушение гораздо важнее.',
            'quote_3': 'Лёд покрывает пол пещеры, и пингвин командует мне: «Скользи!».',
            'quote_4': 'Бессонница — это очень серьезно. Все вокруг кажется таким далеким, копией, снятой с копии, сделанной с еще одной копии.',
            ...
            'films': [
                '1999, США, Германия, реж: Дэвид Финчер',
            ],
        },
        '7': {
            'id': '52179',
        ...
        '8': {
            ...
            'year': '1833',
            'translator': '',
            'quote_1': 'Зима!.. Крестьянин, торжествуя, На дровнях обновляет путь; Его лошадка, снег почуя, Плетётся рысью как-нибудь;',
            'quote_2': 'Они сошлись. Волна и камень, Стихи и проза, лед и пламень Не столь различны меж собой.',
            'quote_3': 'Чем меньше женщину мы любим, Тем легче нравимся мы ей И тем её вернее губим Средь обольстительных сетей.',
            'quote_4': 'Мы все учились понемногу Чему-нибудь и как-нибудь, Так воспитаньем, слава богу, У нас немудрено блеснуть.',
            'quote_5': 'Я к вам пишу — чего же боле? Что я могу еще сказать? Теперь, я знаю, в вашей воле Меня презреньем наказать.',
            'quote_6': 'Мой дядя самых честных правил, Когда не в шутку занемог, Он уважать себя заставил И лучше выдумать не мог.',
            'line_first': 'He мысля гордый свет забавить, Вниманье дружбы возлюбя, Хотел бы я тебе представить Залог достойнее тебя,',
            'line_last': 'Блажен, кто праздник жизни рано Оставил, не допив до дна Бокала полного вина, Кто не дочел ее романа И вдруг умел расстаться с ним, Как я с Онегиным моим.',
            'classificatory': {
                'genre': 'Реализм',
                'genre_code': '',
                'general': 'Психологическое|Социальное',
            ...
            'films': [
                '2024, Россия, реж: Сарик Андреасян',
            ],
        },
        '9': {
            'id': '238538',
        ...
        '11': {
            ...
            'quote_3': 'Потом он ещё подумал-подумал и сказал про себя: «А зачем на свете пчёлы? Для того, чтобы делать мёд! По-моему, так!»',
            'quote_4': 'Наступило недолгое молчание. Крошка Ру свалился в очередную мышиную нору.',
            'quote_5': 'И, конечно, он страшно обрадовался, увидев, что Кролик достаёт чашки и тарелки.',
            ...
            'films': [
                '«_____ ___» 1969, СССР, реж: Фёдор Хитрук',
                '«_____ ___ идёт в гости» 1971, СССР, реж: Фёдор Хитрук',
                '«_____ ___ и день забот» 1972, СССР, реж: Фёдор Хитрук, Геннадий Сокольский',
            ],
        },
    }
}
